// Shared SVG icon components — no emojis, all custom designs

type IconProps = { size?: number; className?: string }
type HeartProps = IconProps & { filled?: boolean }
type StarProps = IconProps & { filled?: boolean }

export function HeartIcon({ filled, size = 16, className }: HeartProps) {
  return filled ? (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#f87171" className={className}>
...
export function PeopleIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function ListIcon({ size = 13, className }: IconProps) {
  return (
...
export function LeaveIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function SparkleIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M12 2l1.5 5H19l-4.5 3.3 1.7 5.2L12 12.5l-4.2 3 1.7-5.2L5 7h5.5z"/>
      <path d="M19.5 12.5l.8 2.5H23l-2.2 1.6.8 2.6-2.1-1.5-2.1 1.5.8-2.6-2.2-1.6h2.7z"/>
      <path d="M4.5 12.5l.8 2.5H8l-2.2 1.6.8 2.6-2.1-1.5-2.1 1.5.8-2.6L1 15h2.7z"/>
    </svg>
  )
}

export function PlateIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function StarIcon({ filled, size = 16, className }: StarProps) {
  return (
