  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white p-10 rounded-2xl border border-gray-100 w-full max-w-md text-center">
        ...
        <h1 className="text-xl font-medium mb-2 text-red-500">Account Banned</h1>
        <p className="text-sm text-gray-400 mb-6">Your account has been permanently banned from SmartFlavr due to a violation of our terms of service.</p>
